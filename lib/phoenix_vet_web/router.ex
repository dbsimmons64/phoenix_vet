defmodule PhoenixVetWeb.Router do
  ...
  scope "/", PhoenixVetWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{PhoenixVetWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", PhoenixVetWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{PhoenixVetWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", PhoenixVetWeb do
    ...
    live_session :current_user,
      on_mount: [{PhoenixVetWeb.UserAuth, :mount_current_user}] do
